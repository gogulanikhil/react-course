...
import Todisplay from "./Profile.js";
const data=[
    {
      "albumId": 1,
      "id": 1,
...
const App=()=>{
 return(
    <section className="posts-container">
        {
            data.map((eachObj) =>{
                // const toshow((id,img,thumbnailUrl,url))=eachObj
// destructurisation to not use same things multiple times
...
//     const{title,thumbnailUrl,url,id}=props
//     // console.log(props)
//     return <article className="profiles">
//     <img src={thumbnailUrl} alt="random pic" ></img>
